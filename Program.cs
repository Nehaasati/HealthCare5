...
while (running)
{
    ...
    else
    {
        ...
        // ---- ADMIN ----
        if (active_user.UserRole == User.Role.Admin)
        {
        ...
        else if (active_user.UserRole == User.Role.Personnel)
        {
            ...
            {
                case "1":
                    if (Permission.HasPermission(active_user, Permission.PermissionType.CanViewScheduleLocation))
                    {
                        Console.Clear();
                        Console.WriteLine("All locations:");
                        if (locations.Count == 0)
                ...
                case "2":
                    ...
                    {
                        Console.WriteLine("You do not have permission to view schedules.");
                        Console.ReadLine();
                    }
                    break;

                case "3":
                    if (Permission.HasPermission(active_user, Permission.PermissionType.CanViewPatientsJournaEntries))
                    {
                        Console.Clear();
                        ...
                        foreach (User user in users)
                        {
                            if (user is Patient patient && patient.SSN == ssn3)
                            {
                        ...
                        if (targetPatient == null)
                            ...
                            Console.WriteLine("Patient not approved. Access denied.");
                        else
                    ...
                    {
                        Console.WriteLine("You do not have permission to view patient journals.");
                        Console.ReadLine();
                    }
                    break;
